...
test('setup calculations', t => {
  ...
  t.deepEqual(lib._setup({min: 0, max: 256}), {bytesNeeded: 1, min: 0, max: 256, target: 256})
  t.deepEqual(lib._setup({min: 0, max: 257}), {bytesNeeded: 2, min: 0, max: 257, target: 257})
  t.deepEqual(lib._setup({min: 2, max: 257}), {bytesNeeded: 1, min: 2, max: 257, target: 255})
  t.deepEqual(lib._setup({min: 2, max: 258}), {bytesNeeded: 1, min: 2, max: 258, target: 256})
  t.deepEqual(lib._setup({min: 2, max: 259}), {bytesNeeded: 2, min: 2, max: 259, target: 257})
  t.deepEqual(lib._setup({min: 0, max: 65535}), {bytesNeeded: 2, min: 0, max: 65535, target: 65535})
  t.deepEqual(lib._setup({min: 0, max: 65536}), {bytesNeeded: 2, min: 0, max: 65536, target: 65536})
  t.deepEqual(lib._setup({min: 0, max: 65537}), {bytesNeeded: 3, min: 0, max: 65537, target: 65537})
  t.deepEqual(lib._setup({min: 0, max: 4294967295}), {bytesNeeded: 4, min: 0, max: 4294967295, target: 4294967295})
  t.deepEqual(lib._setup({min: 0, max: 4294967296}), {bytesNeeded: 4, min: 0, max: 4294967296, target: 4294967296})
  t.deepEqual(lib._setup({min: 0, max: 4294967297}), {bytesNeeded: 5, min: 0, max: 4294967297, target: 4294967297})
